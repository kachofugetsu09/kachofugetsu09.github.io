...
window.SITE_DATA = {
    ...
    "articleDetails": {
        ...
        "CS186/CS186笔记03.md": {
            "title": "CS186 笔记03",
            "preview": "好的，我已将你提供的所有内容整合到一份完整的笔记中，并确保移除了所有引用标记。 以下是优化后的笔记内容： 信息检索 (IR) 是一个传统上与数据库领域分离的研究领域. Hans P. Luhn在1959年提出了“Keyword in Context (KWIC)”. G. Salton在60、70年代开发了SMART系统. 这与关系数据库的革命大约同时发生. 自那时起进行了大量的研究，尤其是在网络...",
            "updateTime": "2025-07-16",
            "wordCount": 3520,
            "readingTime": 24,
