...
window.SITE_DATA = {
    ...
    "MIT6.824": [
        "election_restriction_formatted.md",
        "raft论文研究.md",
        "lab1.md"
    ],
    "interview": [
    ...
    "MIT6.824/election_restriction_formatted.md": {
        "title": "election_restriction_formatted",
        "preview": "#### 5.3 选举限制机制 Raft使用投票的方式来阻止候选人实现选举，除非这个候选人包含了所有已提交的日志。 候选人为了赢得选举必须联系大部分节点 这意味着每个已经提交的日志条目在这些服务器节点中肯定存在于某一个节点之上 如果候选人日志至少和大多数服务器节点一样新，那么他一定持有了所有已经提交的条目 这个规则要解决的核心问题是：防止一个已经被大多数节点确认、但尚未\"正式宣布\"的日志，被后续更...",
        "updateTime": "2025-06-13"
    },
